...
$metaDesc = "Review terms of use, shipping guarantees, returns policy, and purchasing conditions for Elixir & Co. boutique.";
...
<div class="header-container">
    <div class="static-page-layout">
        ...
        <p>Elixir & Co. guarantees that all fragrances offered on our boutique catalog are 100% authentic original products from brand manufacturers. Due to the high value and chemical sensitivity of pure extracts, returned items must be unopened and returned inside their original sealed cellophanes.</p>
        ...
        <p>Elixir & Co. is not liable for direct, indirect, or incidental damages arising from scent allergies or incorrect application of fragrances. We strongly recommend testing new scent signatures on a tiny patch of skin first.</p>
    </div>
</div>
